...
<?php
	...
	//Array bandara asal penerbangan
	$asalPenerbangan = array (
		"Soekarno-Hatta (CGK)", 
		"Husein Sastranegara (BDO)", 
		"Abdul Rachman Saleh (MLG)", 
		"Juanda (SUB)");									
	//Aray bandara tujuan penerbangan 
	$tujuanPenerbangan = array (
		"Ngurah Rai (DPS)", 
		"Hasanuddin (UPG)", 
		"Inanwatan (INX)", 
		"Sultan Iskandarmuda (BTJ)"); 											
	//Array pajak dari bandara asal
	$pajakAsalPenerbangan = array (
		"Soekarno-Hatta (CGK)" =>50000, 
		"Husein Sastranegara (BDO)"=>30000, 
		"Abdul Rachman Saleh (MLG)"=>40000, 
		"Juanda (SUB)"=>40000);	
	//Aray pajak dari bandara tujuan
	$pajakTujuanPenerbangan = array (
...
<body">
		<img style="width: 90%;height:auto;" src="img/pesawat.jpg">
		...
		<form action="index.php" method="post">
			<table width="600px">
				...
				<tr>
					...
					<td>:</td>
					<td>
						<select name="ruteasal"> 																						<!-- Input Bandara Asal -->
	...
	<?php
		if(isset($_POST['submit'])){
			...
			$rutePenerbangan = [$maskapaiPenerbangan, $ruteAsalPenerbangan, $ruteTujuanPenerbangan, $hargaPenerbangan, $totalPajakPenerbangan, $totalHargaPeberbangan];		
			
			// Menghapus duplikasi jika ada
			$rutePenerbanganAll = array_unique($rutePenerbanganAll, SORT_REGULAR);
			if (!in_array($rutePenerbangan, $rutePenerbanganAll)) {
				...
				echo "<div><p>Data sudah ada dalam daftar.</p></div>";
			}
		}
